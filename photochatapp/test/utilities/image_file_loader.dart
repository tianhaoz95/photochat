...
File loadFixtureImageFile(String filename) {
  ...
  if (FileSystemEntity.typeSync(pathRelativeToRoot) != FileSystemEntityType.notFound) {
    File imageFileRelativeToRoot = File(pathRelativeToRoot);
    return imageFileRelativeToRoot;
  } else if (FileSystemEntity.typeSync(pathRelativeToTest) != FileSystemEntityType.notFound) {
